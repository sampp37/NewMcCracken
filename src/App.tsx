            ...
            <div className="max-w-lg w-full">
              ...
              <div className="flex items-center justify-between gap-6 sm:gap-8 w-full">
                <div className="flex-1 flex justify-center">
                  <img src="/award1-p.webp" alt="Award" className="h-36 sm:h-40 lg:h-48 xl:h-52 w-auto max-w-full object-contain transition-transform duration-300 ease-out hover:scale-110 hover:drop-shadow-lg" />
                </div>
                <div className="flex-1 flex justify-center">
                  <img src="/consumersp.webp" alt="Consumer Choice Premier Business 2025" className="h-36 sm:h-40 lg:h-48 xl:h-52 w-auto max-w-full object-contain transition-transform duration-300 ease-out hover:scale-110 hover:drop-shadow-lg" />
                </div>
                <div className="flex-1 flex justify-center">
                  <img src="/S-w-logo-p.webp" alt="Sherwin-Williams Preferred" className="h-36 sm:h-40 lg:h-48 xl:h-52 w-auto max-w-full object-contain transition-transform duration-300 ease-out hover:scale-110 hover:drop-shadow-lg" />
                </div>
              </div>
            </div>
          </div>
