  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white overflow-hidden border-y border-gray-200 shadow-sm py-6">
        <div className="flex items-center px-6 lg:px-12 flex-wrap lg:flex-nowrap">
          ...
          <h3 className="text-xl sm:text-2xl font-extrabold text-gray-900 uppercase tracking-wide whitespace-nowrap mx-auto">
            PROUDLY SPONSORING
          </h3>
        </div>
      </div>
